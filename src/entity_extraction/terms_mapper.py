"""
Система замены терминов Star Wars на вымышленные аналоги.
...
class TermsMapper:
    """
    Маппер для замены терминов Star Wars на вымышленные аналоги.
    ...
    def __init__(self) -> None:
        ...
        logger.info(f"Создан словарь соответствий с {len(self.terms_mapping)} терминами")
    ...
    def process_file(self, input_path: Path, output_path: Path) -> bool:
        ...
        try:
            ...
            logger.info(f"Обработан файл: {input_path.name}")
            return True
    ...
    def save_terms_mapping(self, output_path: Path) -> bool:
        ...
        try:
            ...
            logger.info(f"Словарь соответствий сохранен: {output_path}")
            return True
