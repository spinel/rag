#!/usr/bin/env python3
"""
Упрощенный скрипт для обработки файлов Star Wars с заменой терминов.
...
from src.entity_extraction.terms_mapper_simple import TermsMapperSimple
...
def print_mapping_stats(mapper: TermsMapperSimple) -> None:
    """
...
def create_knowledge_base_readme(output_dir: Path, stats: Dict[str, Any], mapper: TermsMapperSimple) -> None:
    """
